...
def transliterate(name):
    ...
    exc_dictionary = {
        ...
        'Ispr_BP_bloka_soglasuusczego_Syst_Check_Vb':'Ispr_BP_BS_SKV',
        'Btn_Predydusczii_Kr':'Btn_PrevScr',
        'Btn_Sleduusczii_Kr':'Btn_NextScr',
        'Btn_UOZ_menshe_':'Btn_UOZ_Down',
        'Btn_UOZ_bolshe_':'Btn_UOZ_Up',
        'Btn_Prinuditelnyi_O':'Btn_AO',
        'Btn_Normalnyi_O':'Btn_NO',
        'Btn_lock':'Btn_Deblock',
        'Svetovoi_indikator_PS':'SvetInd_PS',
        'Svetovoi_indikator_AS':'SvetInd_AS',
        'Svetovoi_indikator_Prinuditelnyi_O':'SvetInd_AO',
        'Svetovoi_indikator_Normalnyi_O':'SvetInd_NO',
        'Svetovoi_indikator_Pusk_GPA':'SvetInd_Pusk_GPA',
        'Svetovoi_indikator_lock':'SvetInd_Deblock'
    }
...
if __name__ == '__main__':
    ...
    io_list = 'IO_Миннибаевский ГПЗ_ШМШ_v3_20211025.xls'

    #получаем списки из IO листа
    list_DI,list_DO = getDataXls(io_list)

    #создание скриптов добавления структур параметров для запуска в Epsilon
    MakeStrustContent(list=list_DI, name='DI',ab='SHMSH')
    MakeStrustContent(list=list_DO, name='DO',ab='SHMSH')

    #создание скриптов добавления обработчиков параметров для запуска в Epsilon
    MakeCallDI(list=list_DI,name='DI',ab='SHMSH')
    MakeCallDO(list=list_DO, name='DO',ab='SHMSH')

    # создание скриптов привязки логики к HW для запуска в Epsilon
    MakeBindInput(list=list_DI, name='DGI', ab='SHMSH')
    MakeBindOutput(list=list_DO, name='DGO', ab='SHMSH')
