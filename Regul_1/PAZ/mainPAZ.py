...
def transliterate(name):
    ...
    exc_dictionary = {
        ...
        'F_vrash_kolenczatogo_vala':'Fvkv',
        'Razr_na_vnesenie_izmenenii':'RazrVnesIzm',
        'lock_PAZ':'Block_PAZ',
        'Sem_zvuka':'Sound_OF',
        'Signaly_vnutrennei_diagnostiki':'SignVnDiag',
        'ASTP_KUOG':'ASUTP_KUOG',
        '_na_prieme_GMK':'',
        '_na_out_GMK':'',
        '_na_t_linii':'',
        'Aktivnost_Reg':'Aktiv',
        'Zvukovaja_Sig':'Snd',
        'Svetovaja_Sig':'SvetSig'
    }
...
if __name__ == '__main__':
    ...
    io_list = 'IO_Миннибаевский ГПЗ_ШУ ПАЗ_v4_20211026.xls'
    ...
    MakeStrustContent(list=list_AI, name='AI',ab='PAZ')
    #MakeStrustContent(list=list_AO, name='AO',ab='PAZ')
    MakeStrustContent(list=list_DI, name='DI',ab='PAZ')
    MakeStrustContent(list=list_DO, name='DO',ab='PAZ')
    #MakeStrustContent(list=list_FI, name='FI',ab='PAZ')

    #создание скриптов добавления обработчиков параметров для запуска в Epsilon
    MakeCallAI(list=list_AI,name='AI',ab='PAZ')
    #MakeCallAO(list=list_AO,name='AO',ab='PAZ')
    MakeCallDI(list=list_DI,name='DI',ab='PAZ')
    MakeCallDO(list=list_DO, name='DO',ab='PAZ')

    # создание скриптов привязки логики к HW для запуска в Epsilon
    MakeBindInput(list=list_AI, name='AI', ab='PAZ')
    #MakeBindOutput(list=list_AO, name='AO', ab='PAZ')
    MakeBindInput(list=list_DI, name='DGI', ab='PAZ')
    MakeBindOutput(list=list_DO, name='DGO', ab='PAZ')
